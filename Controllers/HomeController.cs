...
public class HomeController : Controller
{
    ...
    {
        Cliente cliente1 = new Cliente(01, "Arthur A. Ferreira", "857.032.9540-41", "arthur.antune@sp.senai.br", "Madruga");
        Cliente cliente2 = new Cliente(02, "William Henry Gates III", "039.618.250-09", "bill@microsoft.com", "Bug");
        Cliente cliente3 = new Cliente(03, "Ada Loveplace", "800.777.920-50", "ada@ada.language.com", "Byron");
        Cliente cliente4 = new Cliente(04, "Linus Torvalds", "933.622.400-03", "torvalds@osdl.org", "Pinguim");
        Cliente cliente5 = new Cliente(05, "Grace Hopper", "011.702.988-00", "grace.hopper@cobol.com", "Loboc");
